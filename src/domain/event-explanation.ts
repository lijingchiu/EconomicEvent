...
const RULES: ExplanationRule[] = [
  ...
  { pattern: /employment cost index/i, chineseName: "就業成本指數季增率（ECI）", definition: "衡量民間與州地方政府勞工薪資、福利等總報酬的季增幅度。", englishName: "Employment Cost Index QoQ", definitionEn: "Measures the quarterly change in wages, salaries and benefit costs for civilian workers." },
  { pattern: /unit labor costs/i, chineseName: "單位勞動成本季增年率", definition: "衡量非農企業每單位產出的勞動成本季增年率，反映工資與生產力共同形成的成本壓力。", englishName: "Unit Labor Costs QoQ", definitionEn: "Measures the annualized quarterly change in nonfarm business labor cost per unit of output." },
  { pattern: /nonfarm productivity/i, chineseName: "非農企業生產力季增年率", definition: "衡量非農企業每工時產出的季增年率，反映生產效率與潛在成長。", englishName: "Nonfarm Productivity QoQ", definitionEn: "Measures the annualized quarterly change in nonfarm business output per hour." },

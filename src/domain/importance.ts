...
export function classifyEventName(name: string): Classification {
  ...
  if (startsWithAny(candidate, ["consumer price index", "core cpi", "inflation rate", "core inflation rate", "producer price index", "core ppi", "pce price index", "core pce", "import and export price indexes", "import prices", "employment cost index", "unit labor costs"])) return { category: "inflation", impact: "high", tracked: true };
  ...
  if (startsWithAny(candidate, ["gross domestic product", "gdp", "personal income and outlays", "personal income", "personal spending", "retail sales", "industrial production", "durable goods orders", "productivity and costs", "nonfarm productivity"])) return { category: "growth", impact: "high", tracked: true };
